...
var CustomControlSpacer = function (_Spacer) {
  ...
  CustomControlSpacer.prototype.createEl = function createEl() {
    ...
    var source = jQuery(jQuery(jQuery(this.player_.children_[0])[0]).find("source")[0]).attr("src");
    var logo = jQuery(jQuery(this.player_.children_[0])[0]).attr("logo");
    var logoLink = jQuery(jQuery(this.player_.children_[0])[0]).attr("logo-link");
    el.innerHTML = '<span class="logoLinkPlayer"><a href="'+logoLink+'" target="_blank"><img src="'+logo+'"></a></span>';
    console.log();

    console.log(jQuery(this.player_.children_[0])[0]);
    // console.log(_this7);
     // console.log((this.player_.children_[0].children));
    return el;
  };
